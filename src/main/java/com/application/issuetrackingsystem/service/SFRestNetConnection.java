package com.application.issuetrackingsystem.service;
...
import com.application.issuetrackingsystem.domain.SF_Rest_API;
...
public class SFRestNetConnection {
	...
	public boolean updateObject(SF_Rest_API sfRestAPI) {
		...
		try {
			...
			URL uri = new URL(baseUri + "/sobjects/" + sfRestAPI.getSfObjectType() + "/" + sfRestAPI.getSfObjectId()
					+ "?_HttpMethod=PATCH");
			...
			if (statusCode == 204) {
				...
				System.out.println(
						sfRestAPI.getSfObjectType() + " update NOT successfully. Status code is " + statusCode);
			}
	...
	public boolean deleteObject(SF_Rest_API sfRestAPI) {
		...
		try {
			...
			if (statusCode == 204) {
				...
				System.out
						.println(sfRestAPI.getSfObjectType() + " delete NOT successful. Status code is " + statusCode);
			}
